...
AWS_ACCESS_KEY_ID = env_or('AWS_ACCESS_KEY_ID', None)
AWS_SECRET_ACCESS_KEY = env_or('AWS_SECRET_ACCESS_KEY', None)
AWS_STORAGE_BUCKET_NAME = env_or('AWS_STORAGE_BUCKET_NAME', None)
...
DEFAULT_FILE_STORAGE = env_or('DEFAULT_FILE_STORAGE', 'shimmy.core.storage.GZIPPipelineCachedStorage')
...
MAILCHIMP_API_KEY = env_or('MAILCHIMP_API_KEY', None)
MAILCHIMP_LIST_ID = env_or('MAILCHIMP_LIST_ID', None)


SQUARE_APPLICATION_ID = env_or('SQUARE_APPLICATION_ID', None)
SQUARE_ACCESS_TOKEN = env_or('SQUARE_ACCESS_TOKEN', None)
SQUARE_LOCATION_ID = env_or('SQUARE_LOCATION_ID', None)


CMS_PAGE_CACHE = env_or('CMS_PAGE_CACHE', True, bool)
CMS_PLACEHOLDER_CACHE = env_or('CMS_PLACEHOLDER_CACHE', True, bool)
CMS_PLUGIN_CACHE = env_or('CMS_PLUGIN_CACHE', True, bool)
